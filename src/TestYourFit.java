 ...
 * Memory Management: TestYourFit.java
 */
...
public class TestYourFit {
   ...
   @Test
    public void testConstructor() {
        ...
        assertTrue(fit.freeMem instanceof ArrayList);
        assertEquals(1, fit.freeMem.size());
        assertTrue(!fit.freeMem.isEmpty());
    }

    // Simple test of allocate
    @Test
    ...
    public void testDeallocate() {
        ...
        assertEquals(70, ((Block) fit.freeMem.get(0)).getSize());
        assertEquals(1, fit.freeMem.size());
        ...
        assertNull(fit.allocatedMem.get(0));
        assertEquals(100, temp.getSize());
        assertEquals(0, temp.getAddress());
        assertEquals(100, ((Block) fit.freeMem.get(0)).getSize());
        assertEquals(170, fit.freeSpace);
        ...
        assertEquals(60, temp.getSize());
        assertEquals(120, temp.getAddress());
        assertEquals(60, ((Block) fit.freeMem.get(1)).getSize());
        ...
        assertEquals(50, temp.getSize());
        assertEquals(230, temp.getAddress());
        assertEquals(50, ((Block) fit.freeMem.get(2)).getSize());
        assertEquals(280, fit.freeSpace);
        ...
        assertEquals(20, temp.getSize());
        assertEquals(100, temp.getAddress());
        assertEquals(20, ((Block) fit.freeMem.get(1)).getSize());
        assertEquals(300, fit.freeSpace);
        ...
        assertEquals(50, temp.getSize());
        assertEquals(180, temp.getAddress());
        assertEquals(50, ((Block) fit.freeMem.get(3)).getSize());
        assertEquals(350, fit.freeSpace);

        assertFalse(fit.allocatedMem.isEmpty());

        temp = fit.deallocate(6);
        assertNull(fit.allocatedMem.get(6));
        assertEquals(50, temp.getSize());
        assertEquals(280, temp.getAddress());
        assertEquals(50, ((Block) fit.freeMem.get(5)).getSize());
        assertEquals(400, fit.freeSpace);
    ...
    public void testDefragment() {
        ...
        assertEquals(90, fit.freeSpace);
        assertEquals(20, ((Block) fit.freeMem.get(0)).getSize());
    }
}