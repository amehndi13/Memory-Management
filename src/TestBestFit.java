 ...
 * Memory Management: TestBestFit.java
 */
...
public class TestBestFit {
    ...
    public void testConstructor() {
        ...
        assertTrue(fit.freeMem instanceof AVLtree);
    ...
    public void testDeallocate() {
        ...
        assertEquals(70, ((Block) fit.freeMem.root()).getSize());
        assertEquals(1, fit.freeMem.size());
    ...
    //first test we made to make sure that the basics were working
    @Test
    public void shortTest() {
        assertEquals(400, fit.freeSpace); 
        fit.allocate(200, false);//a1
        fit.allocate(200, false);//a2
        assertNull(fit.allocate(100,false));//a3
        fit.deallocate(1);
        fit.allocate(50, false); //a4
        fit.allocate(60,false); //a5
        fit.allocate(70, false); //a6
        fit.deallocate(4);
        fit.deallocate(5);
        fit.deallocate(6);
